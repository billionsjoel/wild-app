        ...
        <div class="row header" id="home">
            <div class="col-sm-12">
                <div class="center" style="position: relative;">
                    ...
                    <span class="heading-sub mb-4 border-teal">wild Adventure.</span>
                    <hr class="text-white w-25 center">
                    <span class="heading-sub P-4 mt-4">"Safe and Seemless Experience."</span></p>
