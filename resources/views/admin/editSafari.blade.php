                    ...
                    <form action="{{ url('/edit-safari/' . $safari->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="5" class="form-control" name="body"
                                id="mytextarea">{{ $safari->description }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="overview">Overview</label>
                            <textarea rows="5" class="form-control" name="overview"
                                id="mytextarea">{{ $safari->overview }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="itenerary">Full itenenary</label>
                            <textarea rows="5" class="form-control" name="itenerary"
                                id="mytextarea">{{ $safari->itenerary }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="terms">Terms & Conditions </label>
                            <textarea rows="5" class="form-control" name="terms"
                                id="mytextarea">{{ $safari->terms }}</textarea>
                        </div>
                        <div class="form-group">
