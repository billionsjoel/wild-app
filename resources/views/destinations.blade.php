                ...
                @forelse ($destinations as $destination)
                    {{-- <div class="col-lg-3 p-2">
                        <div class="card align-center" style="width: 18rem;">
                            <img src="{{ asset('images/' . $destination->image) }}" class="card-img-top" alt="...">
                            <div class="card-body">
                    ...
                    <div class="col-lg-4 p-2">
                        <div class="card align-center" style="width: 28rem;">
                            <img class="card-img img-style"
                                style="height:20rem;background-image:linear-gradient(to right bottom, rgb(145, 199, 136, 0.8), rgb(221, 255, 188, 0.8)),url({{ asset('images/' . $destination->image) }}">
